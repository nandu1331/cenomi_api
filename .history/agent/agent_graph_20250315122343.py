...
def create_agent_graph():
    ...
    builder.add_node("tenant_action_node", tenant_action_node)
    ...
    builder.add_edge("tenant_action_node", "llm_call_node")
...
if __name__ == "__main__":
    ...
    result = graph.invoke(input_data, {"recursion_limit": 200})
    print("Result: \n", result)