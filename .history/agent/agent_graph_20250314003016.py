from nodes import input_node, memory_node, output_node, intent_router_node, tool_selection_node
...
def create_agent_graph():
    ...
    builder.add_edge("intent_router_node", "tool_selection_node",
                     condition=lambda state: state.get("next_node") == "tool_selection_node")
    builder.add_edge("intent_router_node", "output_node",
                     condition=lambda state: state.get("next_node") == "output_node")
    builder.add_edge("tool_selection_node", "output_node")
