...
required_fields_prompt_template = ChatPromptTemplate.from_messages([
    ("system", """
        ...
        **Existing field:** {existing_fields}
        ...
        **Instructions:**
        ...
        - Existing fields should not be present in the required fields list because they are already available.
...
class RequiredFieldsCalculator:
    ...
    def calculate_required_fields(self, intent: IntentCategory, user_query: str, db_schema: str, existing_fields: list) -> List[str]:
        """
...
from database_utils import get_db_schema_description, get_db_connection
...
def main():
    ...
    try:
        while True:
            ...
            existing_fields = list(input("Enter fields you already have"))
