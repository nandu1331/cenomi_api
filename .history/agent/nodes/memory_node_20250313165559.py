...
def memory_node(state):
    ...
    buffer_memory.chat_memory.messages = state.get("chat_history", [])
    ...
    updated_summary_history = summary_memory.predict_new_summary(current_summary, messages=[(user_query, "")])
