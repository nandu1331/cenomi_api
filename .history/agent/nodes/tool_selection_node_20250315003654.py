...
class ToolName(str, Enum):
    ...
    SQL_DB_SEARCH = "sql_db_search"

AVAILABLE_TOOLS = {
    ToolName.VECTOR_DB_SEARCH: ToolName.VECTOR_DB_SEARCH,
    ToolName.SQL_DB_SEARCH: ToolName.SQL_DB_SEARCH
}
...
def tool_selection_node(state: AgentState) -> AgentState:
    ...
    if intent in [
        ...
        print("General customer query detected. Selecting VectorDB Search Tool.")
        selected_tools = [ToolName.VECTOR_DB_SEARCH] # Select VectorDB Search Tool for customer queries
        next_node = "tool_invocation_node"
    elif intent in [
        IntentCategory.CUSTOMER_QUERY_LIST_MALLS,
        IntentCategory.CUSTOMER_QUERY_LIST_STORES,
        IntentCategory.CUSTOMER_QUERY_MALL_SERVICES,
        IntentCategory.CUSTOMER_QUERY_STORE_DETAILS
    ]:
        print("Structured query detected. Selecting SQL Database Tool.")
        selected_tools = [ToolName.SQL_DB_SEARCH]
        next_node = "tool_invocation_node"
