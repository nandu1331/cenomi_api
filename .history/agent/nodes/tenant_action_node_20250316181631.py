...
def tenant_action_node(state: AgentState) -> AgentState:
    ...
    return handle_tenant_data_operation(updated_state, intent, user_query)

def handle_tenant_data_operation(state: AgentState, intent: IntentCategory, user_query: str) -> AgentState:
    """
    ...
    required_fields = required_fields_cal.calculate_required_fields(intent, user_query, db_schema_str, extracted_fields)
