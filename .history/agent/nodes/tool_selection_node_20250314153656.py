...
def tool_selection_node(state: AgentState) -> AgentState:
    ...
    elif intent == IntentCategory.CUSTOMER_QUERY_EVENT_INFO: # Example: For event listing queries, select SQL Tool (adjust intent as needed)
        print("Event listing query detected. Selecting SQL Database Tool.")
        selected_tools = [ToolName.SQL_DB_SEARCH] # Select SQL Database Tool
        next_node = "tool_invocation_node"
    else:
