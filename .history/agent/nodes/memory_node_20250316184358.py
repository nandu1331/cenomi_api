...
def memory_node(state: AgentState) -> AgentState:
    ...
    buffer_memory.save_context({"user_query": user_query}, {"response": assistant_response}, {"tenant_main_query": tenant_main_query})
    summary_memory.save_context({"user_query": user_query}, {"response": assistant_response}, {"tenant_main_query": tenant_main_query})
