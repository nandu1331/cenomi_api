    ...
    try:
        ...
        sql_generation_prompt_template = ChatPromptTemplate.from_messages([
            ("system", f"""
                ...
                Operation: {operation_type}. Entity: {entity_type}. Fields: {required_fields}. Data: {tenant_data}
                """),
            ("human", f"Generate SQL query to {operation_type} {entity_type} with data: {tenant_data}. Required fields: {required_fields}")
        ])
