...
def memory_node(state: AgentState) -> AgentState:
    ...
    buffer_memory.save_context({"user_query": user_query}, {"response": assistant_response})
    summary_memory.save_context({"user_query": user_query}, {"response": assistant_response})
    ...
    updated_state = AgentState(
        ...
        response=None  # Reset response for new input
    )
